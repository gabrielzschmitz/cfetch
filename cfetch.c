...
int main(int argc, char* argv[]) {
  ...
  if (art == NULL) {
    printf(
      "Art file not found! Make it at "
      "\e[96m/usr/share/cfetch/yourart.art\e[39m.\n");
    return 1;
  }
  char* line = NULL;
  ssize_t size;
  ...
  for (int i = 0; run; i++) {
    ...
    switch (i) {
      case 0:
        printf("\e[31m\e[1m󰋑 \e[37m· \e[30m\e[0m%s%s\n", fetch_distro(),
               color);
        break;
      case 1:
        printf("\e[36m\e[1m󰌽 \e[37m· \e[30m\e[0m%s%s\n", fetch_kernel(),
               color);
        break;
      case 2:
        printf("\e[32m\e[1m󰔚 \e[37m· \e[30m\e[0m");
        fetch_uptime();
        break;
      case 3:
        printf("\e[33m\e[1m󱂬 \e[37m· \e[30m\e[0m%s%s\n", fetch_wm_name(),
               color);
        break;
      case 4:
